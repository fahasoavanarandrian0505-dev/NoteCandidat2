...
<body>
    <div class="container">
        ...
        <h1><%= isEdit ? "✎ Modifier Matière" : "➕ Ajouter Matière" %></h1>

        <form method="POST" action="<%= isEdit ? "/matieres/mettre-a-jour/" + matiere.getIdMatiere() : "/matieres/creer" %>">
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<%= isEdit ? matiere.getNomMatiere() : "" %>"
                       required>
            </div>

            <div class="button-group">
                <button type="submit" class="btn-submit">✓ <%= isEdit ? "Mettre à jour" : "Créer" %></button>
                <a href="/matieres" class="btn-cancel">✕ Annuler</a>
            </div>
        </form>
    </div>
</body>
