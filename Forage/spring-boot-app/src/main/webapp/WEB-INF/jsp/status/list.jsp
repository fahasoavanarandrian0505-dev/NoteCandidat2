    ...
    <div class="container">
        <div class="content">
            ...
            <c:if test="${empty statusList}">
                <p style="color: #c8d6e5;">Aucun statut trouve.</p>
            </c:if>
                ...
                <table>
                    ...
                    <tbody>
                        <c:forEach items="${statusList}" var="status">
                            <tr>
                                <td>${status.idStatus}</d>
                                <td>${status.libelle}</d>
                                <td><a href="/status/edit/${status.idStatus}" class="btn btn-edit">Modifier</a>
                                        <a href="/status/delete/${status.idStatus}" class="btn btn-delete" onclick="return confirm('Supprimer ce statut ?')">Supprimer</a></d>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
